...
A CPU benchmarking tool in native-rust inspired from [Duremark](https://github.com/sergev/duremark) or CoreMark. 
...
- Matrix
- Math ops
- Split scores per kernel
- Add --mem-size CLI
- Add target-cpu=native detection
- Add perf event integration
- Add multi-core scaling mode
- Add FP / SIMD kernels
